function y = syseqs (x_k, x_k1, u_k, u_k1, phi_k, Imassv_k, Ixiq_k, Inel_k, phi_k1, Imassv_k1, Ixiq_k1, Inel_k1,....
        mb, lb, rhob, Ab, g, Mp, Eb, Ib, modeno, T, cfl, ks, x0_k, uo0_k)
...
H_k(2:1+modeno) = cfl*(Eb*Ib/rhob*Ab)*Inel_k*eta_k.' + cfl*thetadot_k^2*Imassv_k*eta_k.' + 0*(eta_k-eta0_k).';
